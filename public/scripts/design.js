...
//       card.innerHTML = `
//         <img src="${imageUrl || "https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg"}"
//              class="card-img-top" alt="${title}">
//         <div class="card-body">
//           <h5 class="card-title">${title}</h5>
//           <p class="card-text">
...
//           </p>
//           <div class="form-check">
//             <input class="form-check-input select-design" type="checkbox" value="${title}" data-price="${price}">
...
//         } else {
//           selectedDesigns = selectedDesigns.filter((d) => d.title !== checkbox.value);
//           card.style.border = "";
//         }
...
//             Price: $${price.toFixed(2)}
//           </p>
//           <div class="selected-badge d-none">✔ Selected</div>
//           <button class="btn btn-primary mt-3 select-btn">Customize</button>
//         </div>
//       `;
